...
```bash
curl -fsSL https://raw.githubusercontent.com/Agent-Guard-Org/agent-guard/main/scripts/install.sh | bash
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/Agent-Guard-Org/agent-guard/main/scripts/install.sh | bash -s -- -y --scope global
```
